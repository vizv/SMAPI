...
namespace StardewModdingAPI
{
    public static class Log
    {
        ...
        public static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            File.WriteAllText(Constants.LogDir + Path.DirectorySeparatorChar + "MODDED_ErrorLog.Log_" + DateTime.UtcNow.Ticks + ".txt", e.ExceptionObject.ToString());
        }
        ...
        public static void Application_ThreadException(object sender, ThreadExceptionEventArgs e)
        {
            ...
            File.WriteAllText(Constants.LogDir + Path.DirectorySeparatorChar + "MODDED_ErrorLog.Log_" + Extensions.Random.Next(100000000, 999999999) + ".txt", e.Exception.ToString());
        }
